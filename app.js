...
//buttons are not working due to addEventListener issue
...
// API being used is the Open Library API
...
// should lead user to new page, that shows details about an individual book 
...
async function saveBookToShelf(aBook){// should build a new item in shelf page when a button is clicked
    ...
    class bookToShelf extends HTMLElement{
